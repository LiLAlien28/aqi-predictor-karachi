...
def fetch_current_aqi():
    try:
        resp = requests.get(
            f"https://api.waqi.info/feed/geo:{KARACHI_LAT};{KARACHI_LON}/?token={WAQI_TOKEN}",
            timeout=30,
        )
...
with st.sidebar:
    ...
    st.markdown("""
        <div style="text-align:center; padding:15px 0 5px 0; border-top:1px solid rgba(255,255,255,0.06); margin-top:14px;">
            <div style="color:#6dd3ff; font-weight:700; font-size:14px;">👨‍💻 Muhammad Aamir</div>
            ...
            <div style="display:flex; justify-content:center; gap:12px; margin-top:8px; font-size:13px;">
                <a href="https://www.linkedin.com/in/moaamir28" target="_blank" style="color:#6dd3ff; text-decoration:none;">LinkedIn</a>
                <a href="https://github.com/LiLAlien28" target="_blank" style="color:#6dd3ff; text-decoration:none;">GitHub</a>
            </div>
        </div>
    """, unsafe_allow_html=True)
...
if forecast_data:
    ...
    st.markdown("""
        <div style="text-align:center; padding:10px 0 5px 0;">
            <h1 style="font-size:46px; margin:0; letter-spacing:-0.5px;">🌍 Karachi AQI Forecast</h1>
            ...
            <p style="color:#5b6478; font-size:14px; margin-top:4px;">
                Built by <strong style="color:#6dd3ff;">Muhammad Aamir</strong> • 10 Pearls Shine Intern • Cohort 9
            </p>
        </div>
    """, unsafe_allow_html=True)
        ...
        st.markdown(f"""
            <div class="glass-card">
                ...
                <div style="font-size:13px; color:#8b93a7; margin-top:8px; text-align:left;">
                    ...
                    <div style="margin-top:8px; font-size:11px; color:#5b6478;">Last sync: {datetime.now().strftime('%Y-%m-%d %H:%M')}</div>
                </div>
            </div>
        """, unsafe_allow_html=True)
...
st.markdown(f"""
    <div class="footer">
        ...
        <p>Built with ❤️ by <strong style="color:#6dd3ff;">Muhammad Aamir</strong> • 10 Pearls Shine Intern • Cohort 9</p>
        <p style="font-size:12px; color:#5b6478;">🚀 Production-Grade MLOps Pipeline • FastAPI + Streamlit • Feature Importance Analysis</p>
        <p style="font-size:11px; color:#3d4457; margin-top:8px;">Last refreshed {datetime.now().strftime('%Y-%m-%d %H:%M')} · © 2026 All Rights Reserved</p>
    </div>
""", unsafe_allow_html=True)
